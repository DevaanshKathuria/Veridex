    ...
    <AuthGuard>
      <div className="mx-auto max-w-5xl px-4 py-8">
        <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
          ...
          <Button variant="outline" onClick={() => navigator.clipboard.writeText(window.location.href)}><Share2 className="size-4" /> Share</Button>
        </div>
        {query.isLoading || !analysis ? (
          ...
          <div className="space-y-4">
            ...
            {analysis.summary ? <p className="rounded-lg border border-border bg-surface p-4 text-sm leading-6 text-text-secondary">{analysis.summary}</p> : null}
